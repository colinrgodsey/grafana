...
function (angular, $, kbn, moment, _, HistogramTooltip) {
  'use strict';
  ...
  module.directive('grafanaHistogram', function($rootScope, timeSrv) {
    return {
      ...
      link: function(scope, elem) {
        ...
        function addPercentAxis(options, data) {
          console.log(data)
          ...
          options.xaxis = {
            ...
            mode: null,//"time",
            min: scope.xRange[0],//min,
            max: scope.xRange[1],//max,
            label: "Percentile",
            //ticks: ticks,
