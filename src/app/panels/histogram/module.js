...
function (angular, app, $, _, kbn, moment, TimeSeries, PanelMeta, HdrHistogram) {
  'use strict';
  ...
  module.controller('HistogramCtrl', function($scope, $rootScope, panelSrv, annotationsSrv, timeSrv) {

    $scope.panelMeta = new PanelMeta({
      description: 'Histogram panel',
      fullscreen: true,
      metricsEditor: true
    });

    $scope.panelMeta.addEditorTab('Axes & Grid', 'app/panels/histogram/axisEditor.html');
    $scope.panelMeta.addEditorTab('Display Styles', 'app/panels/histogram/styleEditor.html');
    ...
    $scope.dataHandler = function(results) {
      ...
      $scope.xRange = results.xRange;
      $scope.yRange = results.yRange;
